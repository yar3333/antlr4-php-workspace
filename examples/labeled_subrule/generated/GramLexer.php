...
class GramLexer extends Lexer
{
	...
	static function _serializedATN() : string
	{
		return
			...
			"\u{2}\u{3}\u{7}\u{8}\u{1}\u{4}\u{2}\u{9}\u{2}\u{3}\u{2}\u{3}\u{2}\u{2}".
			"\u{2}\u{3}\u{3}\u{3}\u{3}\u{2}\u{2}\u{2}\u{6}\u{2}\u{3}\u{3}\u{2}\u{2}".
			"\u{2}\u{3}\u{5}\u{3}\u{2}\u{2}\u{2}\u{5}\u{6}\u{7}\u{5A}\u{2}\u{2}\u{6}".
			"\u{4}\u{3}\u{2}\u{2}\u{2}\u{3}\u{2}\u{2}";
	}
	/**
	 * @var ATN
	 */

...
{
	function andEquation(int $i) : AndEquationContext
	{
...
{
	function equation(int $i) : EquationContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function numericExpression(int $i) : NumericExpressionContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function multiplyingExpression(int $i) : MultiplyingExpressionContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function powExpression(int $i) : PowExpressionContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function atom(int $i) : AtomContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function number(int $i) : NumberContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function parameter(int $i) : ParameterContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
...
{
	function simpleFilterExpression(int $i) : SimpleFilterExpressionContext
	{
	    /** @noinspection PhpIncompatibleReturnTypeInspection */
